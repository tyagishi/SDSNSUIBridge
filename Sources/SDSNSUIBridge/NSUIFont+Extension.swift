...
extension NSUIFont {
    static public func boldFont(ofSize fontSize: CGFloat)  -> NSUIFont {
#if os(macOS)
    ...
    static public func italicFont(ofSize fontSize: CGFloat)  -> NSUIFont {
#if os(macOS)
    ...
    static public func boldItalicFont(ofSize fontSize: CGFloat)  -> NSUIFont {
#if os(macOS)
        return NSFontManager.shared.font(withFamily: NSUIFont.systemFont(ofSize: fontSize).fontName,
